...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const titles = ["Sr. Creative Designer", "Art Director", "Video Content Creator"];
    let currentIndex = 0;
    const rotatingElement = document.getElementById("rotating-titles");
    const pauseBetweenTitles = 2000; // Milliseconds to pause between titles
    const initialPause = 3000; // Initial pause before first title starts sliding out
